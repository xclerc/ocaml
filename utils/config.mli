...
(* CR mshinwell: Change this name to ban Obj.set_tag too *)
val ban_obj_dot_truncate : bool
        (* If [true], the size of heap-allocated blocks cannot be changed,
           thus banning the use of [Obj.truncate]. *)
