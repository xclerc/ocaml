...
*)
    let tracker =
      { Gc.Memprof.alloc_minor = minor_alloc_callback;
        alloc_major = major_alloc_callback;
        promote = promote_callback;
        dealloc_minor = minor_dealloc_callback;
        dealloc_major = major_dealloc_callback;
      }
    in
    Gc.Memprof.start ~sampling_rate ~callstack_size tracker
